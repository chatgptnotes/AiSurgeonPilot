...
export default function AdminClinicalDoctorsPage() {
  ...
  const fetchDoctors = async () => {
    ...
    // Only fetch doctors created by this admin clinical
    ...
    <div className="p-6 lg:p-8">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-6">
        <div>
          ...
          <p className="text-gray-500 mt-1">Manage your registered doctors</p>
        </div>
