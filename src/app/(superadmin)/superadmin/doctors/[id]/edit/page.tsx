  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const { error: updateError } = await supabase
      ...
      .update({
        ...
        booking_slug: formData.bookingSlug.trim() || null,
    ...
    if (updateError) {
      ...
      router.push(`/superadmin/doctors/${params.id}`)
    }
  ...
  return (
    <div className="p-6 lg:p-8 max-w-4xl mx-auto">
      ...
      <div className="flex items-center gap-4 mb-6">
        <Link href={`/superadmin/doctors/${params.id}`}>
      ...
      <form onSubmit={handleSubmit}>
        ...
        <Card className="mb-6">
          <CardHeader>
            ...
            <CardDescription>Clinic and consultation information</CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="space-y-2">
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  onChange={(e) => handleChange('bookingSlug', e.target.value)}
                  disabled={isSaving}
                />
              </div>
            </div>
        ...
        <Card className="mb-6">
          <CardHeader>
            ...
            <CardDescription>Manage doctor verification and account status</CardDescription>
          </CardHeader>
          <CardContent className="space-y-6">
            <div className="flex items-center justify-between">
              <div>
                <Label htmlFor="isVerified">Verified</Label>
                <p className="text-sm text-gray-500">Doctor can receive appointments when verified</p>
              </div>
              <Switch
                id="isVerified"
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-sm text-gray-500">Inactive doctors cannot log in</p>
              </div>
              <Switch
                id="isActive"
