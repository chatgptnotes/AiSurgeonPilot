...
// GET - List all doctors (for superadmin)
...
// Helper function to send credentials via email using Resend
...
// Helper function to send credentials via WhatsApp using DoubleTick
